...
//        if (static::usesTrait($object, 'Tacone\Coffee\Base\EntriesAsPropsTrait')) {
//            $keys = array_merge($keys, array_keys($object->toArray()));
//        }
        return $keys;
    }
    ...
    public static function handleExposeables(
        ...
        $parentProperties = static::getProperties($parent);
